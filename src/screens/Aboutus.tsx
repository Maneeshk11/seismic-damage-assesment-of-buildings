    ...
    return (
        <div className="w-full py-8 mt-12">
            ...
            <div className="flex flex-row items-center w-4/5 justify-around my-10 mx-auto">
                <ProfileCard profileImage={M1Img} name={"MANEESH KOLLI"} role={"FULL STACK DEVELOPER"} twitterUrl="https://twitter.com/ManeeshKolli" githubUrl="https://github.com/Maneeshk11" linkedinUrl="https://www.linkedin.com/in/maneeshkolli/" facebookUrl="" />
                <ProfileCard profileImage={N1Img} name={"P VIVEK REDDY"} role={"FRONT END DEVELOPER"} githubUrl="https://github.com/twist-hub" linkedinUrl="https://www.linkedin.com/in/p-vivek-reddy-7400a524a/" facebookUrl=""  twitterUrl=""/>
